...
function Welcome () {
    ...
    return ( 
        <main className='challenge-container mb-10 flex flex-col items-center'>
            <div className='challenge-header p-4 flex w-11/12 align-middle justify-around'>
                <div className='progress-icon-container'>
                <img src={alien} alt='Happy alien' className='progress-icon w-24 shake-animation'/>
                </div>
            ...
            <div className='items-container flex flex-col pt-4'>
